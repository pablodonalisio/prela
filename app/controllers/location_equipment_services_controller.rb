class LocationEquipmentServicesController < ApplicationController
  ...
  def create
    @location_equipment_service = authorize @location_equipment.location_equipment_services.build(create_params)
  ...
  def create_params
    params.require(:location_equipment_service).permit(:service_kind_id, :interval, :interval_unit)
  end
