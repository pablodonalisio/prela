class Reports::EquipmentStats < Reports::Content
  ...
  def equipment_stats
    ...
    @pdf.table([
      ...
      [{content: "Carga asociada"}, {content: ups_report_stat.associated_charge.to_s}, {content: "-"}],
      [{content: "Carga de la batería"}, {content: ups_report_stat.battery_charge.to_s}, {content: "-"}],
